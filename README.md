...
> **Early alpha:** FreeCord `0.8.0-alpha.7` is intended for hands-on testing. Installers are unsigned, upgrades may require manual work, and the project has not received an independent security audit.
