...
> **Early alpha:** FreeCord `0.8.0-alpha.1` is intended for hands-on testing. Installers are unsigned, upgrades may require manual work, and the project has not received an independent security audit.
...
FreeCord is distributed under the [BSD 3-Clause License](LICENSE).
